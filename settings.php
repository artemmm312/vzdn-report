<button class="btn btn-primary shadow" id="settings_btn" type="button" data-bs-toggle="modal"
	...
	<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="row">
					<div class="quantity_of_product col-6 mx-auto mb-3">
						<label class="form-label mb-0" for="quantity_of_tare" style="font-size: 14px">Планируемое количество
							реализовать "ПЭТ-тара":</label>
						<input class="form-control" id="quantity_of_tare" type="number" value="0" min="0">
					</div>
					<div class="quantity_of_product col-6 mx-auto mb-3">
						<label class="form-label mb-0" for="quantity_of_drink" style="font-size: 14px">Планируемое количество
							реализовать "Вода, напитки":</label>
			...
			<div class="modal-footer">
				...
				<button class="btn btn-success shadow-sm" id="save" type="button" data-bs-target="#settingsSaved"
